...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn("relative md:hidden flex justify-center items-center", className)}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId="nav"
            className=" bottom-full mb-2 inset-x-0 flex flex-row gap-2"
          >
            {items.map((item, idx) => (
              <motion.div
                key={item.title}
